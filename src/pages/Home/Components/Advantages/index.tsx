    ...
    <ContainerAdvantages>
      <ContentText data-aos="fade-right" data-aos-duration="1000">
        ...
        <TextRegular weight={500}>
          ...
          <strong>
            {" "}
            Segurança, Atendimento Personalizado e Logística Eficiente{" "}
          </strong>{" "}
          para tornar suas entregas um sucesso garantido.
        </TextRegular>
        ...
        <ListAdvantages>
          ...
          <AdvantageBox>
            ...
            <div>
              ...
              <TextRegular size="sm" weight={500}>
                Oferecemos uma extensa gama de soluções logísticas, adaptadas às

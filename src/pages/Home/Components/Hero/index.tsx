      ...
      >
        <ContentSwiper>
          ...
          <ContentText data-aos="fade-right" data-aos-duration="1000">
            <TitleText color="white" size="hero">
        ...
        <ContentSwiper>
          ...
          <ContentText
            className="contentTextCenter"
            data-aos="fade-right"
            data-aos-duration="1000"
          >
            <TitleText color="white" size="hero">
              Entregamos Soluções de Logística Que Vão Além da Distância!
            </TitleText>
            <TextRegular color="white">
              Oferecemos soluções logísticas completas para conectar seu negócio
              ao destino certo, com confiança e eficiência.
        ...
        <ContentSwiper>
          ...
          <ContentText data-aos="fade-right" data-aos-duration="1000">
            <TitleText color="white" size="hero">
              Sua Carga, Nosso Compromisso: Chegamos Onde Você Precisa!
            </TitleText>
            <TextRegular color="white">
              Oferecemos soluções logísticas completas para conectar seu negócio
              ao destino certo, com confiança e eficiência.

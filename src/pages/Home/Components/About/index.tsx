    ...
    <ContainerAbout id='about'>
      ...
      <ContainerTextAbout data-aos="fade-left" data-aos-duration="1000">
        ...
        <TextRegular size='s' className='TextAbout'>
          ...
          <strong> Com anos de experiência, somos especialistas em oferecer as 
            soluções logísticas ideais </strong>  para que suas entregas sejam ágeis e seguras.
          <strong> Confiança, qualidade e dedicação estão no centro de tudo o que fazemos. </strong>
        </TextRegular>

        <TextRegular>
          Cuidamos de cada detalhe. <strong> Desde o atendimento personalizado 
          até a entrega pontual </strong> estamos sempre ao seu lado, 
          garantindo que <strong> suas expectativas sejam superadas em cada 
          etapa do transporte. </strong>
        </TextRegular>
